function setName() {
    document.getElementById('humanName').innerHTML = prompt('Elige un nombre');
}
...
function singleRound(playerPlays, computerPlays)    {
    ...
    if (playerPlays == computerPlays) draw++;
     ...
     if (draw == 3) {
        document.getElementById('overlayText').textContent = "Empate!";
        document.getElementById('overlay').style.display = 'block';
     }  else if (playerPoints == 3) {
        document.getElementById('overlayText').textContent = "Ganaste!";
        document.getElementById('overlay').style.display = 'block';

        }   else if (cpuPoints == 3) {
            document.getElementById('overlayText').textContent = "Computadora gana!";
            document.getElementById('overlay').style.display = 'block';
